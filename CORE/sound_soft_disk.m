% Class representing sound soft circular scatterers
%
%   scat = sound_soft_disk(k,r) sets up object for a circle with radius r.
%   The wavenumber is k.
%
...
classdef sound_soft_disk < design
    ...
    methods
        ...
        function self = sound_soft_disk(kwave,radius,name)

            % set default name
            if nargin<3
                name = 'sound soft disk';
            end
            ...
            T = mie_tmatrix(kwave,radius,n,'SOFT');
